    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <section className="max-w-5xl mx-auto py-16 px-4">
        ...
        <p className="text-gray-700 dark:text-gray-300 text-lg text-center mb-8">
          ATREE เป็นร้านอาหาร Halal กลางเมืองเชียงใหม่ จำหน่ายอาหารหลากหลาย เช่น โจ๊ก, ข้าวหมก, โรตี, ชาชัก
          เรามุ่งมั่นในการนำเสนออาหารที่อร่อยและปลอดภัยสำหรับทุกคน
        </p>
