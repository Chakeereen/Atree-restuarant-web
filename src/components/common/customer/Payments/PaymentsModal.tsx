...
export default function PaymentModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="w-full max-w-sm mx-auto p-4 text-gray-900 dark:text-gray-100 transition-colors">
        {step === "SELECT" && (
          <div className="text-center space-y-4">
            ...
            <div className="flex flex-col gap-3 mt-4">
              <button
                className="w-full flex items-center justify-center gap-2 bg-orange-500 text-white py-3 rounded-lg hover:bg-orange-600 dark:hover:bg-orange-600 transition-colors"
              ...
              <button
                className="w-full flex items-center justify-center gap-2 bg-blue-500 text-white py-3 rounded-lg hover:bg-blue-600 dark:hover:bg-blue-600 transition-colors"
                onClick={() => setStep("QR")}
              >
            ...
            {qr ? (
              <div className="flex flex-col items-center gap-4 mt-4">
                <img
                  src={qr}
                  alt="QR Code"
                  className="mx-auto w-48 h-48 object-contain border rounded shadow-md dark:border-gray-600"
                />

                <a
                  href={qr}
                  download={`PromptPay_${totalPrice}.png`}
                  className="w-full flex items-center justify-center gap-2 bg-gray-500 text-white py-3 rounded-lg hover:bg-gray-600 dark:hover:bg-gray-700 transition-colors"
                >
                ...
                <button
                  ...
                  className="w-full bg-blue-500 text-white py-3 rounded-lg hover:bg-blue-600 dark:hover:bg-blue-600 transition-colors"
                >
                  ถัดไป
                </button>
              </div>
