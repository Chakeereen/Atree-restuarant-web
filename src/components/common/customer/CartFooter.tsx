...
export default function CartFooter({ totalItems, totalCost, onSubmit, isSubmitting }: CartFooterProps) {
  return (
    <footer className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white border-t shadow-inner">
      <div className="p-4">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="font-bold text-xl text-gray-800">รวม ฿{Number(totalCost).toFixed(2)}</span>
        </div>
        <button
          onClick={onSubmit}
