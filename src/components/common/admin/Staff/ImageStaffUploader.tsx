...
export default function ImageStaffUploader({ nameImage = "image", nameFileID = "fileID" }: ImageUploaderProps) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await fetch(`${baseUrl}/api/admin/staff/image`, { method: "POST", body: formData });
